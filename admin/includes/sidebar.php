<!-- Sidebar navigation-->
<script src="https://kit.fontawesome.com/0050544443.js" crossorigin="anonymous"></script>
<nav class="sidebar-nav">
    ...
    <ul id="sidebarnav">
        ...
        class="hide-menu">Ajouter un Client</span></a></li>
        ...
        class="hide-menu">Clients Acc.</span></a></li>
        ...
        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="bookings.php"
         ...
         class="hide-menu">Réservations</span></a>   
        </li>

        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="manage-clients.php"
        aria-expanded="false"><i class="fas fa-users"></i><span
        class="hide-menu">Clients & Salles</span> <i class="fa-solid fa-building-user"></i></a></li>
        ...
        class="hide-menu">Salles</span></a></li>
        ...
        <li class="sidebar-item"> <a class="sidebar-link sidebar-link" href="manage-matériels.php"
        aria-expanded="false"><i class="fas fa-book"></i><span
        class="hide-menu">Matériels</span></a>
