            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h4 class="page-title text-truncate text-dark font-weight-medium mb-1">Historique des
                            Réservations</h4>
                                    ...
                                    <table id="zero_config"
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="clients-profile.php?id=<?php echo $row->id; ?>"
                                                        title="Afficher tous les détails"><i
                                                            class="icon-size-fullscreen"></i></a>&nbsp;&nbsp;
                                                    <a href="manage-clients.php?del=<?php echo $row->id; ?>"
